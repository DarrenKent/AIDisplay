...
namespace ai {
    namespace Scavenger {
        ...
        HoverAgent::HoverAgent( float x, float y, float z ) {
            ...
            mBeamTexture        = mTextureMgr->LoadTexture( "data/beam.tga", true );
            mObjectTexture      = mTextureMgr->LoadTexture( "data/object.tga", false );
            mScanTexture        = mTextureMgr->LoadTexture( "data/scanner.tga", false );
            mChargeTexture      = mTextureMgr->LoadTexture( "data/charge.tga", false );
            ...
            mBeam->LoadModel( "data/dronebeam.obj", mBeamTexture );
            mObject->LoadModel( "data/object.obj", mObjectTexture );
            mScan->LoadModel( "data/scanner.obj", mScanTexture );
            mCharge->LoadModel( "data/charge.obj", mChargeTexture );
